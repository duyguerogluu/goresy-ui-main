...
Currently we set environment variables using the [env-config.js](public/env-config.js) file. Before running the application locally, you can update them according to your needs.
